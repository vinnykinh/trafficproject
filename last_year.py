...
def run_inference_for_single_image(model, image):
    ...
    # ==================================
    suma = sum(output_dict['detection_scores'] > .80)
    print(suma)
    k = output_dict['detection_boxes'][0] * (10 ** 2)
    print("count ", suma)
    mySocket.sendto(str(suma).encode('utf-8'), (SERVER_IP, PORT_NUMBER))
...
def show_inference(model, image_np):
    ...
    final_img = vis_util.visualize_boxes_and_labels_on_image_array(
        ...
        output_dict['detp[[pection_scores'],
        category_index,
